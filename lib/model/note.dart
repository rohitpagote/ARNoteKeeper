...
import 'package:flutter_unity_example/services.dart' show NoteQuery;
...
class Note extends ChangeNotifier {
  ...
  bool get AR => state == NoteState.AR;
...
enum NoteState { unspecified, pinned, archived, deleted, AR }
...
extension NoteStateX on NoteState {
  ...
  bool get canCreate => (this <= NoteState.pinned || this == NoteState.AR);

  /// Checks if a note in this state can edit (modify / copy).
  bool get canEdit => this < NoteState.deleted || this == NoteState.AR;
